import {
  ...
  export const PasswordEmail = ({
    ...
    <Html>
      <Head />
      <Preview>Your newly generated password</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Below is your newly AI generated password! You can change it as soon as you gain access to your dashboard and please do not forget to alway keep your password a secret:
          </Text>
